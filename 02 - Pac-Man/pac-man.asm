...
__c089:     
            ...
            INY                ; $c08c: c8        
            BNE __c089         ; $c08d: d0 fa     
            LDY #$00           ; $c08f: a0 00     
__c091:     
            LDA __c0eb,y       ; $c091: b9 eb c0  
            STA $0052,y        ; $c094: 99 52 00  
            INY                ; $c097: c8        
            CPY #$0f           ; $c098: c0 0f     
            BNE __c091         ; $c09a: d0 f5     
            LDA #$01           ; $c09c: a9 01     
            STA $64            ; $c09e: 85 64     
__c0a0:     
            LDY #$00           ; $c0a0: a0 00     
            ...
            LDA #$01           ; $c0a8: a9 01     
            CMP $47            ; $c0aa: c5 47     
            BNE __c0c7         ; $c0ac: d0 19     
            CMP $46            ; $c0ae: c5 46     
            BNE __c0c7         ; $c0b0: d0 15     
__c0b2:     LDA $0077,y        ; $c0b2: b9 77 00  
            STA $00            ; $c0b5: 85 00     
            LDA $0067,y        ; $c0b7: b9 67 00  
            STA $0077,y        ; $c0ba: 99 77 00  
            LDA $00            ; $c0bd: a5 00     
            STA $0067,y        ; $c0bf: 99 67 00  
            INY                ; $c0c2: c8        
            CPY #$10           ; $c0c3: c0 10     
            BNE __c0b2         ; $c0c5: d0 eb     
__c0c7:     LDA #$1f           ; $c0c7: a9 1f     
            STA $4015          ; $c0c9: 8d 15 40  
            LDA #$c0           ; $c0cc: a9 c0     
            STA $4017          ; $c0ce: 8d 17 40  
            JSR __ee18         ; $c0d1: 20 18 ee  
            JSR __ee40         ; $c0d4: 20 40 ee  
            LDA #$88           ; $c0d7: a9 88     
            STA $43            ; $c0d9: 85 43     
            STA PPUCTRL          ; $c0db: 8d 00 20  
            LDA #$ff           ; $c0de: a9 ff     
            STA $48            ; $c0e0: 85 48     
            STA $023f          ; $c0e2: 8d 3f 02  
            STA $024b          ; $c0e5: 8d 4b 02  
            JMP __c168         ; $c0e8: 4c 68 c1  
...
nmi:        
            ...
            PHA                ; $c0fe: 48        
            LDA #$1e           ; $c0ff: a9 1e     
            STA PPUMASK          ; $c101: 8d 01 20  
            LDA #$00           ; $c104: a9 00     
            STA OAMADDR          ; $c106: 8d 03 20  
            STA $40            ; $c109: 85 40     
            LDA $45            ; $c10b: a5 45     
            STA OAMDMA          ; $c10d: 8d 14 40  
            JSR __dde9         ; $c110: 20 e9 dd  
            JSR __e21c         ; $c113: 20 1c e2  
            LDA $41            ; $c116: a5 41     
            STA PPUSCROLL          ; $c118: 8d 05 20  
            LDA $42            ; $c11b: a5 42     
            STA PPUSCROLL          ; $c11d: 8d 05 20  
            LDA $47            ; $c120: a5 47     
            AND $46            ; $c122: 25 46     
            AND #$01           ; $c124: 29 01     
            ASL                ; $c126: 0a        
            ORA $43            ; $c127: 05 43     
            STA PPUCTRL          ; $c129: 8d 00 20  
            LDA #$01           ; $c12c: a9 01     
            STA $4016          ; $c12e: 8d 16 40  
            LDA #$00           ; $c131: a9 00     
            STA $4016          ; $c133: 8d 16 40  
            LDX #$08           ; $c136: a2 08     
__c138:     LDA $4016          ; $c138: ad 16 40  
            AND #$03           ; $c13b: 29 03     
            CMP #$01           ; $c13d: c9 01     
            ROR $4d            ; $c13f: 66 4d     
            LDA $4017          ; $c141: ad 17 40  
            AND #$03           ; $c144: 29 03     
            CMP #$01           ; $c146: c9 01     
            ROR $4e            ; $c148: 66 4e     
            DEX                ; $c14a: ca        
...
__c41b:     LDA __c455,x       ; $c41b: bd 55 c4  
            ...
            JMP __c1de         ; $c42c: 4c de c1  

;-------------------------------------------------------------------------------
__c42f:     LDA $4d            ; $c42f: a5 4d     
            AND #$08           ; $c431: 29 08     
            CMP $51            ; $c433: c5 51     
            BNE __c43a         ; $c435: d0 03     
            JMP __c1de         ; $c437: 4c de c1  

;-------------------------------------------------------------------------------
__c43a:     STA $51            ; $c43a: 85 51     
            LDA $51            ; $c43c: a5 51     
            BNE __c443         ; $c43e: d0 03     
            JMP __c1de         ; $c440: 4c de c1  

;-------------------------------------------------------------------------------
__c443:     LDA #$00           ; $c443: a9 00     
            STA $48            ; $c445: 85 48     
            JSR __ee40         ; $c447: 20 40 ee  
            JMP __c98a         ; $c44a: 4c 8a c9  

;-------------------------------------------------------------------------------
__c44d:     .hex 22 0a 5c 00   ; $c44d: 22 0a 5c 00   Data
            .hex 22 4a 20 ff   ; $c451: 22 4a 20 ff   Data
__c455:     .hex 5c            ; $c455: 5c            Data
__c456:     .hex 20 5c         ; $c456: 20 5c         Data

;-------------------------------------------------------------------------------
            LDA $4d            ; $c458: a5 4d     
            AND #$0c           ; $c45a: 29 0c     
            BEQ __c465         ; $c45c: f0 07     
            LDA #$02           ; $c45e: a9 02     
            STA $3f            ; $c460: 85 3f     
            JMP __c168         ; $c462: 4c 68 c1  

;-------------------------------------------------------------------------------
__c465:     LDY $87            ; $c465: a4 87     
            LDA __c474,y       ; $c467: b9 74 c4  
            STA $10            ; $c46a: 85 10     
            LDA __c475,y       ; $c46c: b9 75 c4  
            STA $11            ; $c46f: 85 11     
            JMP ($0010)        ; $c471: 6c 10 00  

;-------------------------------------------------------------------------------
__c474:     .hex 8c            ; $c474: 8c            Data
__c475:     .hex c4 b9 c4 b9   ; $c475: c4 b9 c4 b9   Data
...
;-------------------------------------------------------------------------------
            ...
            LDA $88            ; $c4bb: a5 88     
            CMP #$30           ; $c4bd: c9 30     
            BNE __c4cc         ; $c4bf: d0 0b     
            LDA #$00           ; $c4c1: a9 00     
            STA $88            ; $c4c3: 85 88     
            JSR __c4ec         ; $c4c5: 20 ec c4  
            INC $87            ; $c4c8: e6 87     
            INC $87            ; $c4ca: e6 87     
__c4cc:     JMP __c1de         ; $c4cc: 4c de c1  
...
__c509:     LDA $87            ; $c509: a5 87     
            ...
            TAY                ; $c510: a8        
            LDX #$10           ; $c511: a2 10     
__c513:     LDA __c688,y       ; $c513: b9 88 c6  
...
;-------------------------------------------------------------------------------
__d48a:     .hex 00            ; $d48a: 00            Data
__d48b:     .hex 01 d0 00 28   ; $d48b: 01 d0 00 28   Data
            .hex 01 28 02 90   ; $d48f: 01 28 02 90   Data
            .hex 03 38 00 20   ; $d493: 03 38 00 20   Data
__d497:     .hex 03 18 01 60   ; $d497: 03 18 01 60   Data
            .hex 02 30 01 10   ; $d49b: 02 30 01 10   Data
__d49f:     .hex 02            ; $d49f: 02        Invalid Opcode - KIL 
            PHA                ; $d4a0: 48        
            .hex 01            ; $d4a1: 01        Suspected data
__d4a2:     .hex 18 02 40 01   ; $d4a2: 18 02 40 01   Data
            .hex 20 02 18 00   ; $d4a6: 20 02 18 00   Data
            .hex 20 03 40 02   ; $d4aa: 20 03 40 02   Data
...
__ea79:     LDA $4b            ; $ea79: a5 4b     
            AND #$07           ; $ea7b: 29 07     
            BEQ __ea80         ; $ea7d: f0 01     
            RTS                ; $ea7f: 60        

;-------------------------------------------------------------------------------
__ea80:     LDA $4b            ; $ea80: a5 4b     
            AND #$08           ; $ea82: 29 08     
...
__eab5:     .hex 00 00 00 04   ; $eab5: 00 00 00 04   Data
...
__ee34:     STA $f7            ; $ee34: 85 f7     
            LDA #$1f           ; $ee36: a9 1f     
            STA $4015          ; $ee38: 8d 15 40  
            LDA #$c0           ; $ee3b: a9 c0     
            STA $4017          ; $ee3d: 8d 17 40  
